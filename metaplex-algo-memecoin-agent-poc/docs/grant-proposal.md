...
**Date:** March 2026
**Requested Grant:** $12,000 SOL equivalent

---

## Executive Summary

This is a runnable OpenClaw-style skill called create_memecoin_from_trend.It does exactly what Stephen asked for:

- Scans niche crypto memes and trends from X and TikTok
- Uses AI to generate token name, symbol, description, and artwork prompt
- Launches the token via Metaplex memecoin mode on Solana devnet

The skill is designed to be copy-paste runnable so anyone in the new Metaplex agent library can fork it and experiment immediately.  This PoC delivers real running code (3 tokens already minted on devnet) and serves as one of the first open-source references for Metaplex’s agent library.

---

How to Run This Skill (Copy-Paste Ready)

1. Copy the prompt below into Claude, Grok, or any OpenClaw-style agent.
2. Replace [TREND] with any current X or TikTok crypto meme trend.
3. The agent outputs everything needed for a Metaplex launch.
4. Paste the output into the Metaplex memecoin launchpad on devnet.

Runnable Prompt Template:

```
Act as the create_memecoin_from_trend OpenClaw skill for Metaplex.
Current trend: [TREND]
Generate:
- Name
- Symbol (3-5 letters)
- Description (max 200 chars)
- AI image prompt (vibrant 2026 crypto meme style)
Format everything as ready-to-use Metaplex memecoin launch params with fair anti-snipe defaults.
```
...
| --- | --- | --- |
| Ai inference & Image generation | $200 - $500 | Claude/Grok + Image Tools |
| Tools, Devnet fees, RPCs | 0 - $300 | Mostly free on Devnet |
| Optional freelance help (automation / API wiring) | $300 - $700 | For future full version if needed |
| Execution SubTotal | $500 - $1500 | N/L |
| Premium for time, documentation, open-source, repo, iterations and contribution to metaplex library ( approx 6-8 weeks part-time effort) | $10,000 - $11,500 | Builder margin + ecosystem Value |
| Total Ask  | $12,000 SOL | Milestone-Based (50% on PoC + doc, 50% on full repo + tests) |

---

## Milestones & Open-Source Plan

Milestones & Open-Source PlanMilestone 1: PoC Complete (this submission)

- Runnable OpenClaw-style skill with copy-paste prompt
- 3 real devnet tokens minted
- Full documentation + GitHub repo (MIT licensed)

Milestone 2: Full Open-Source Reference

- Clean prompts and examples for the agent library
- Video walkthrough
- Easy fork instructions for other builders

Milestone 3: Future Iterations (if grant approved)

- More launches and community feedback
- Optional deeper automation

All code is MIT licensed and published at:

https://github.com/Benjamin1290/metaplex-algo-memecoin-agent-poc
